            ...
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Thank you for your interest in volunteering as a pro bono
                  physician
                </p>
              </div>
            </div>
              ...
              <div ref={documentsSectionRef} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div
                    ...
                    } rounded-lg p-4 flex flex-col items-center justify-center h-64 bg-gray-50 cursor-pointer hover:bg-gray-100 transition duration-200`}
                    onClick={() =>

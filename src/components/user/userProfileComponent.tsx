...
{showPrescriptionModal && (
  ...
  >
    ...
    >
      ...
      <div className="bg-white border-b border-gray-200 rounded-t-xl p-4 flex items-center justify-between flex-shrink-0">
        ...
        <button
          ...
          className="text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-full p-2 transition-colors -mr-2"
        >
          <X className="w-5 h-5" />
        </button>
      </div>

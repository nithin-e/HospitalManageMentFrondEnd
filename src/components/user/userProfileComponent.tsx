...
const UserProfileComponent = () => {
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] p-4">
    <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[85vh] flex flex-col">
      ...
      <div className="sticky top-0 bg-white z-10 border-b border-gray-200 rounded-t-xl p-4 flex justify-between items-center">
        ...
        <div className="p-4">
          {prescriptionLoading ? (
            ...
            <div className="space-y-4">
              ...
              {/* Patient and Doctor Information - Single Row on Desktop */}
              ...
              {/* Appointment Details - More Compact */}
              ...
              {/* Appointment Notes - Conditional and Compact */}
              ...
              {/* Prescription Details - More Compact */}
              <div className="bg-blue-50 p-3 rounded-lg border border-blue-100">
                <h4 className="font-medium text-blue-700 mb-2 text-sm flex items-center">

...
{showPrescriptionModal && (
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] p-3 sm:p-4">
    <div className="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[90vh] flex flex-col">
      {/* Sticky Header with Close Button - More Compact */}
      <div className="sticky top-0 bg-white z-10 border-b border-gray-200 rounded-t-xl p-3 flex justify-between items-center">
        ...
        <button
          ...
          className="text-gray-500 hover:text-gray-700 bg-white rounded-full p-1 hover:bg-gray-100 transition-colors flex-shrink-0 ml-2"
        >
          ...
          {prescriptionLoading ? (
            ...
            <div className="space-y-3">
              ...
              <div className="text-center">
                ...
                <h2 className="text-base font-bold text-gray-800">Medical Prescription</h2>
                <p className="text-gray-500 text-xs mt-0.5">Generated from consultation</p>
              </div>

              {/* Patient and Doctor Info in Columns */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {/* Patient Info */}
                <div className="bg-blue-50 p-2 rounded-lg border border-blue-100">
                  <div className="flex items-center mb-1">
                    <User className="w-3 h-3 text-blue-600 mr-1" />
                    <h4 className="font-medium text-blue-700 text-xs">Patient</h4>
                  </div>
                  <div className="space-y-1">
                    <div>
                      <p className="text-[10px] text-gray-500">Name</p>
                      <p className="font-medium text-xs truncate">
                        {prescriptionData.patientName || userData?.name || "N/A"}
                      </p>
                    </div>
                    <div>
                      <p className="text-[10px] text-gray-500">Phone</p>
                      <p className="font-medium text-xs">
                        {prescriptionData.patientPhone || userData?.phoneNumber || "N/A"}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-green-50 p-2 rounded-lg border border-green-100">
                  <div className="flex items-center mb-1">
                    ...
                    <h4 className="font-medium text-green-700 text-xs">Doctor</h4>
                  </div>
                  <div className="space-y-1">
                    <div>
                      <p className="text-[10px] text-gray-500">Name</p>
                      <p className="font-medium text-xs truncate">
                        {prescriptionData.doctorName || "N/A"}
                      </p>
                    </div>
                    <div>
                      <p className="text-[10px] text-gray-500">Specialty</p>
                      <p className="font-medium text-xs truncate">
                        {prescriptionData.specialty || "General"}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 p-2 rounded-lg border border-gray-200">
                <div className="flex items-center mb-1">
                  ...
                  <h4 className="font-medium text-gray-700 text-xs">Appointment</h4>
                </div>
                <div className="grid grid-cols-2 gap-1.5">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-xs">₹{prescriptionData.amount || "0"}</p>
                  </div>
                </div>
              </div>

              {/* Appointment Notes - Even More Compact */}
              {prescriptionData.notes && (
                <div className="bg-yellow-50 p-2 rounded-lg border border-yellow-100">
                  <div className="flex items-center mb-1">
                    <Clipboard className="w-3 h-3 text-yellow-600 mr-1" />
                    <h4 className="font-medium text-yellow-700 text-xs">Notes</h4>
                  </div>
                  <div className="bg-white p-1.5 rounded border border-yellow-200 max-h-20 overflow-y-auto">
                    <p className="text-xs text-gray-700 whitespace-pre-wrap">
                      {prescriptionData.notes.length > 100 
                        ? prescriptionData.notes.substring(0, 100) + "..." 
                        : prescriptionData.notes}
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-blue-50 p-2 rounded-lg border border-blue-100">
                <div className="flex items-center mb-1">
                  <Pill className="w-3 h-3 text-blue-600 mr-1" />
                  <h4 className="font-medium text-blue-700 text-xs">Prescription</h4>
                </div>
              ...
              <div className="text-center text-[10px] text-gray-400 pt-2 border-t">
                <p>ID: {prescriptionData._id?.substring(0, 6) || "N/A"} • Consultation Only</p>
              </div>
            </div>
          ) : (
            <div className="text-center py-6">
              <FileText className="w-8 h-8 mx-auto mb-2 text-gray-400" />
              <h4 className="text-sm font-medium text-gray-700 mb-1">No Prescription</h4>

...
import Hero from '@/components/user/user1/Hero';
import About from '@/components/user/user1/About';
import Services from '@/components/user/user1/Services';
  ...
  return (
    ...
    >
      ...
      <main className="w-full mx-auto">
        <Hero doctorImage="public/lovable-uploads/mainDoctor.png" />
        <About />
        <Services />
        <Stats />
        <Doctors />

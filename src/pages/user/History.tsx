    ...
    <div className="min-h-screen bg-white py-16">
      <section className="max-w-4xl mx-auto px-6">
        <header className="mb-16">
          <div className="mb-8">
            <h2 className="text-5xl font-light tracking-tight mb-4" style={{ color: 'rgb(0, 59, 115)' }}>
              Project History
            </h2>
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <span className="font-medium" style={{ color: 'rgb(0, 59, 115)' }}>Nithin</span>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            <h3 className="text-xl font-medium mb-8" style={{ color: 'rgb(0, 59, 115)' }}>
              Timeline
            </h3>
            <ol className="space-y-10">
              <li className="flex gap-4">
                <div className="flex flex-col items-center">
                  <div className="w-3 h-3 rounded-full mt-1" style={{ backgroundColor: 'rgb(0, 59, 115)' }}></div>
                  <div className="w-px h-full bg-gray-200 mt-2"></div>
                </div>
                <div className="pb-6">
                  <p className="font-medium mb-1">Idea & Prototype</p>
                  <p className="text-sm text-gray-500 mb-2">January 2020</p>
                  <p className="text-sm text-gray-600">A weekend prototype and the first lines of code.</p>
                </div>
              </li>
              ...
              <li className="flex gap-4">
                ...
                <div className="pb-6">
                  ...
                  <p className="text-sm text-gray-600">Invited friends, early feedback and feature pruning.</p>
                </div>
              </li>
              ...
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Wider launch with community-driven improvements.</p>
                </div>
              </li>
            </ol>
          </div>
          ...
          <div>
            ...
            <div className="rounded-lg border border-gray-200 overflow-hidden">
              <svg viewBox="0 0 400 250" className="w-full h-64 bg-gray-50" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Fictional map showing the project's origin">
                <defs>
            ...
            <p className="mt-4 text-xs text-gray-500">
              The map above is illustrative and fictional — created for storytelling purposes.
            </p>
          </div>
        </section>
      </section>
